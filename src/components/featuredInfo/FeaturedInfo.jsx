  ...
  return (
    <div className='featured'>
        ...
        <div className="featuredItem">
            ...
            <div className="featuredMoneyContainer">
                <span className="featuredMoney">$5415</span>
        ...
        <div className="featuredItem">
            ...
            <div className="featuredMoneyContainer">
                <span className="featuredMoney">$2275</span>
                <span className="featuredMoneyRate">+4.3<ArrowUpward className='featuredIcon positive'/></span>
            </div>
            <span className="featuredSub">Compared to last month</span>
        </div>
    </div>
